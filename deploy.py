...
master_data = pickle.load(open(r'C:\Users\Alsaba\Desktop\Alsaba Complete Project\Book Recommendation\uncleaned_master_data.pkl','rb'))
famous_books = pickle.load(open(r'C:\Users\Alsaba\Desktop\Alsaba Complete Project\Book Recommendation\most_famous_books.pkl','rb'))
model_data = pickle.load(open(r'C:\Users\Alsaba\Desktop\Alsaba Complete Project\Book Recommendation\model_data.pkl','rb'))

st.sidebar.header('User Input Parameters')

reader_age = st.sidebar.number_input('Enter your age',min_value=6,max_value=120,step=1)
reader_userid = st.sidebar.number_input('enter your user_id',min_value=1,step=1)
book_read = st.sidebar.text_input('enter book you have read')
...
user_collab_data = model_data[['avg_rating','num_times_book_rated','num_of_books_read','book_status']].head(100000)
...
age_model_data=model_data[['User-ID','Book-Title','Age','num_of_books_read']].head(500000)
